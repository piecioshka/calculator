...
var kwotaNetto = 109900
var rata = 1569
var oprocentowanie = 0.07990000 //powinno być {{interestValue / 100}}
var oprocentowanie2 = 0.09382145
var oprocentowanie3 = 0.09441073
var oprocentowanie4 = 0.09441172
var oprocentowanie5 = 0.09441172
...
function deriv2(i) {
  if (i === 0) {
    ...
    -(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie2, tki(i) + 1) === 0) {
    return null
  } else {
    return (-(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie2, tki(i) + 1))
  }
...
function deriv3(i) {
  if (i === 0) {
    ...
    -(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie3, tki(i) + 1) === 0) {
    return null
  } else {
    return -(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie3, tki(i) + 1)
  }
...
function deriv4(i) {
  if (i === 0) {
    ...
    -(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie4, tki(i) + 1) === 0) {
    return null
  } else {
    return -(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie4, tki(i) + 1)
  }
...
function deriv5(i) {
  if (i === 0) {
    ...
    -(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie5, tki(i) + 1) === 0) {
    return null
  } else {
    return -(aki(i) * tki(i)) / Math.pow(1 + oprocentowanie5, tki(i) + 1);
  }
