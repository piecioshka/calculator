...
function deriv1(i) {
  if (i === 0) {
    ...
    (aki(i) * tki(i)) / Math.pow(1 + oprocentowanie, tki(i) + 1) ===
    0
  ) {
    return null;
  } else {
...
function deriv2(i) {
  if (i === 0) {
    ...
    (aki(i) * tki(i)) / Math.pow(1 + oprocentowanie2, tki(i) + 1) ===
    0
  ) {
    return null;
  } else {
...
function deriv3(i) {
  if (i === 0) {
    ...
    (aki(i) * tki(i)) / Math.pow(1 + oprocentowanie3, tki(i) + 1) ===
    0
  ) {
    return null;
  } else {
...
function deriv4(i) {
  if (i === 0) {
    ...
    (aki(i) * tki(i)) / Math.pow(1 + oprocentowanie4, tki(i) + 1) ===
    0
  ) {
    return null;
  } else {
...
function deriv5(i) {
  if (i === 0) {
    ...
    (aki(i) * tki(i)) / Math.pow(1 + oprocentowanie5, tki(i) + 1) ===
    0
  ) {
    return null;
  } else {
